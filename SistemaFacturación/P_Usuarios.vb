        ...
        Try
            ...
            If TXT_BuscarUsuario.Text <> "" Then
                If RDB_BuscarCodigo.Checked = True Then
                    SQL = "SELECT u.ID, u.codigo, u.usuario, u.clave, u.color FROM usuario u where u.codigo LIKE '%" & TXT_BuscarUsuario.Text & "%'"
                ElseIf RDB_BuscarNombre.Checked = True Then
                    SQL = "SELECT u.ID, u.codigo, u.usuario, u.clave, u.color FROM usuario u where u.usuario LIKE '%" & TXT_BuscarUsuario.Text & "%'"
                End If
            Else
                SQL = "SELECT u.ID, u.codigo, u.usuario, u.clave, u.color FROM usuario u"
            End If
            Cargar_Tabla(T, SQL)
